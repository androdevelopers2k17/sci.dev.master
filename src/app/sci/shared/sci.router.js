            ...
            .state('SCI', {
                ...
                resolve: {
                    ...
                    LoadState: ["$ocLazyLoad", "CheckAccess", function ($ocLazyLoad, CheckAccess) {
                        return $ocLazyLoad.load(["navBar", "navbarDropdownMenu", "footerBar", "sideBar", "eAxis"]);
                    }]
                }
            })
            .state('SCI.dashboard', {
