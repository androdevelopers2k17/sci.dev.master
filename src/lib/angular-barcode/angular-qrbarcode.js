/*
Copyright (c) 2017 20Cube Logistics Pvt Ltd
This plugin based on angular-barcode and angular-qrcode
13 Nov 2017
...
! function (t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define("angular-qrbarcode", [], e) : "object" == typeof exports ? exports["angular-qrbarcode"] = e() : t["angular-qrbarcode"] = e()
}(this, function () {
    return function (t) {
        function e(r) {
        ...
        var o = n(43),
            i = r(o);
        e.default = angular.module("angular-qrbarcode", []).directive("angularBarcode", i.default).directive('angularQrcode', qrCode), t.exports = e.default
    }, function (t, e) {
        "use strict";
        ...
        var o = n(18),
            ...
            p = n(22),
            d = r(p);
        e.EAN13 = i.default, e.EAN8 = u.default, e.EAN5 = c.default, e.EAN2 = l.default, e.UPC = d.default
    }, function (t, e, n) {
        "use strict";
                    ...
                    var o = function () {
                        ...
                        u = function (t) {
                            return Object.keys(a).forEach(function (e) {
                                t.hasOwnProperty(e) ? t[e] = t[e] || a[e] : t[e] = a[e]
                            }), t
                        },
                        s = function (t) {
                            var n = angular.element(o()),
                                a = r.$viewValue || "",
                                u = (0, i.default)(n[0], a, t);
                            return angular.forEach(e.children(), function (t) {
                                return t.remove()
                            }), e.append(n), u
                        };
                    s(u(t.hasOwnProperty("bcOptions") && "undefined" != typeof t.bcOptions ? t.bcOptions : a)), t.$watch("bcOptions", function (t) {
                        s(t)
                    }, !0), r.$render = function () {
                        s(t.bcOptions)
                    }
